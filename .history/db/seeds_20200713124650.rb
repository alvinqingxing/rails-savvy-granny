...
job1 = Job.create!(
  name: 'Forgot ID / Password',
  description: [[true, 'For existing users of services'], [true, 'Internet / Phone bils'], [true, 'GIRO walkthroughs']],
  duration: [10,30,60].sample,
  category: cat1
)
job2 = Job.create!(
  name: 'Resetting Accounts / Passwords',
  description: [[true, 'Life / Health / Medical insurance'], [true, 'GIRO walkthroughs'], [false, 'Insurer information not required']],
  duration: [10,30,60].sample,
  category: cat1 
)
