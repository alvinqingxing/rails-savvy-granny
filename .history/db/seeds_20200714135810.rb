...
user_1 = User.create(
  ...
  password: 'password',
  tutor: false,
  description: "I live with my mom, my dad, my two cats and one bird. I don't
                really know how explain technology in Chinese."
)
...
tutor_1 = User.create(
  ...
  password: 'password',
  tutor: true,
  description: "I've spent so much time teaching my own parents that it's about."
)
