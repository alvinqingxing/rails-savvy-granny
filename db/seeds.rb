...
user_1 = User.create(
  ...
  password: 'password',
  tutor: false,
  description: "I live with my mom, my dad, my two cats and one bird. I don't really know how explain technology in Chinese."
)
...
user_2 = User.create(
  ...
  password: 'password',
  tutor: false,
  description: "I signed up for this because it was easier than teaching my mom how to attach pictures to an email for the 50th time."
)
...
user_3 = User.create(
  ...
  password: 'password',
  tutor: false,
  description: "I'm passionate about Instagram and Twitter, but not really about teaching my dad how to use it..."
)
...
user_4 = User.create(
  ...
  password: 'password',
  tutor: false,
  description: "I honestly barely get how SignPass works, so explaining it to my father is going to be even worse."
)
...
tutor_1 = User.create(
  ...
  password: 'password',
  tutor: true,
  description: "After so much time spent teaching my own parents, I've decided to become a tutor so I can turn my expereince into profit instead of pain."
)
...
tutor_2 = User.create(
  ...
  password: 'password',
  tutor: true,
  description: "I feel a real sense of accomplishment when I can help people understand and connect with each other through technology."
)
